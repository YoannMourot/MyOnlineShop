    ...
    <div id="pagecontent">
      ...
      <div class="container">
        <section class="infoscompte">
          ...
          <h5>Prénom : <?php echo $_SESSION['firstname'] ?> <button data-toggle="collapse" data-target="#changefirstname"><img src="images/UIressources/modifytext.svg" alt="modifier" height="15" width="15"></button></h5>
